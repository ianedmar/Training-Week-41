...
console.log("Sum of the numbers:", totalSum);
...
console.log("Sum using function:", sumArray(numbers));
...
console.log("Position using function:", findFruitPosition('raspberry'));
...
for (let i = 0; i < fruits.length; i++) {
    if (fruits[i].charAt(0).toLowerCase() === 'b') {
        fruitsWithB.push(fruits[i]);
    }
}

console.log("Fruits that start with 'b':", fruitsWithB);
console.log("Number of fruits that start with 'b':", fruitsWithB.length);
...
console.log("Are lists A and B exactly the same?", areEqual);
